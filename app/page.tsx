...
// Selesai! Mengarah ke blog-section dengan alias huruf Kapital agar tidak blank
import { certificationSection as CertificationSectionComponent } from '@/components/blog-section'
        ...
        <div className="flex flex-col lg:flex-row gap-3 sm:gap-4 md:gap-6">
          ...
          <main className="flex-1 bg-card rounded-xl md:rounded-2xl border border-border overflow-hidden">
            ...
            <nav className="flex gap-1 sm:gap-2 md:gap-4 p-3 sm:p-4 md:p-6 border-b border-border overflow-x-auto scrollbar-hide">
              {['about', 'resume', 'portfolio', 'certification', 'contact'].map((section) => (
                <button
                  key={section}
            ...
            <div className="p-4 sm:p-5 md:p-6 lg:p-8">
              ...
              {activeSection === 'certification' && <CertificationSectionComponent data={certificationData} />}
